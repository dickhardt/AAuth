# draft-hardt-aauth-bootstrap draft-hardt-aauth-budgets draft-hardt-aauth-events draft-hardt-aauth-r3 draft-hardt-oauth-aauth-protocol 
...
versioned/draft-hardt-aauth-bootstrap-00.md: | versioned
	git show "draft-hardt-aauth-bootstrap-00:draft-hardt-aauth-bootstrap.md" | sed -e 's/draft-hardt-aauth-bootstrap-date/2026-04-29/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-00/g' -e 's/draft-hardt-aauth-protocol-date/2026-04-13/g' -e 's/draft-hardt-aauth-protocol-latest/draft-hardt-aauth-protocol-01/g' -e 's/draft-hardt-aauth-r3-date/2026-08-14/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-aauth-bootstrap-00\//; }' >$@
...
versioned/draft-hardt-aauth-bootstrap-01.md: | versioned
	git show "draft-hardt-aauth-bootstrap-01:draft-hardt-aauth-bootstrap.md" | sed -e 's/draft-hardt-aauth-bootstrap-date/2026-05-06/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-01/g' -e 's/draft-hardt-aauth-r3-date/2026-08-14/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-05-06/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-01/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-aauth-bootstrap-01\//; }' >$@
...
versioned/draft-hardt-aauth-bootstrap-02.md: draft-hardt-aauth-bootstrap.md | versioned
	sed -e 's/draft-hardt-aauth-bootstrap-date/2026-08-14/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-02/g' -e 's/draft-hardt-aauth-budgets-date/2026-08-14/g' -e 's/draft-hardt-aauth-budgets-latest/draft-hardt-aauth-budgets-00/g' -e 's/draft-hardt-aauth-events-date/2026-08-14/g' -e 's/draft-hardt-aauth-events-latest/draft-hardt-aauth-events-00/g' -e 's/draft-hardt-aauth-r3-date/2026-08-14/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-08-14/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-11/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-aauth-bootstrap-02\//; }' $< >$@
...
diff-draft-hardt-aauth-bootstrap.html: versioned/draft-hardt-aauth-bootstrap-01.txt versioned/draft-hardt-aauth-bootstrap-02.txt
	-$(iddiff) $^ > $@
.INTERMEDIATE: versioned/draft-hardt-aauth-budgets-00.md
versioned/draft-hardt-aauth-budgets-00.md: draft-hardt-aauth-budgets.md | versioned
	sed -e 's/draft-hardt-aauth-bootstrap-date/2026-08-14/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-02/g' -e 's/draft-hardt-aauth-budgets-date/2026-08-14/g' -e 's/draft-hardt-aauth-budgets-latest/draft-hardt-aauth-budgets-00/g' -e 's/draft-hardt-aauth-events-date/2026-08-14/g' -e 's/draft-hardt-aauth-events-latest/draft-hardt-aauth-events-00/g' -e 's/draft-hardt-aauth-r3-date/2026-08-14/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-08-14/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-11/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-aauth-budgets-00\//; }' $< >$@
	$(LIBDIR)/make-includes.sh "HEAD" "draft-hardt-aauth-budgets-00" "$@"
...
versioned/draft-hardt-aauth-events-00.md: draft-hardt-aauth-events.md | versioned
	sed -e 's/draft-hardt-aauth-bootstrap-date/2026-08-14/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-02/g' -e 's/draft-hardt-aauth-budgets-date/2026-08-14/g' -e 's/draft-hardt-aauth-budgets-latest/draft-hardt-aauth-budgets-00/g' -e 's/draft-hardt-aauth-events-date/2026-08-14/g' -e 's/draft-hardt-aauth-events-latest/draft-hardt-aauth-events-00/g' -e 's/draft-hardt-aauth-r3-date/2026-08-14/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-08-14/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-11/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-aauth-events-00\//; }' $< >$@
...
versioned/draft-hardt-aauth-r3-00.md: draft-hardt-aauth-r3.md | versioned
	sed -e 's/draft-hardt-aauth-bootstrap-date/2026-08-14/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-02/g' -e 's/draft-hardt-aauth-budgets-date/2026-08-14/g' -e 's/draft-hardt-aauth-budgets-latest/draft-hardt-aauth-budgets-00/g' -e 's/draft-hardt-aauth-events-date/2026-08-14/g' -e 's/draft-hardt-aauth-events-latest/draft-hardt-aauth-events-00/g' -e 's/draft-hardt-aauth-r3-date/2026-08-14/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-08-14/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-11/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-aauth-r3-00\//; }' $< >$@
...
versioned/draft-hardt-oauth-aauth-protocol-00.md: | versioned
	git show "draft-hardt-oauth-aauth-protocol-00:draft-hardt-oauth-aauth-protocol.md" | sed -e 's/draft-hardt-aauth-bootstrap-date/2026-04-29/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-00/g' -e 's/draft-hardt-aauth-r3-date/2026-08-14/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-04-29/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-00/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-oauth-aauth-protocol-00\//; }' >$@
...
versioned/draft-hardt-oauth-aauth-protocol-09.md: | versioned
	git show "draft-hardt-oauth-aauth-protocol-09:draft-hardt-oauth-aauth-protocol.md" | sed -e 's/draft-hardt-aauth-bootstrap-date/2026-05-06/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-01/g' -e 's/draft-hardt-aauth-events-date/2026-08-14/g' -e 's/draft-hardt-aauth-events-latest/draft-hardt-aauth-events-00/g' -e 's/draft-hardt-aauth-r3-date/2026-08-14/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-07-05/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-09/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-oauth-aauth-protocol-09\//; }' >$@
...
.SECONDARY: versioned/draft-hardt-oauth-aauth-protocol-10.xml
versioned/draft-hardt-oauth-aauth-protocol-10.md: | versioned
	git show "draft-hardt-oauth-aauth-protocol-10:draft-hardt-oauth-aauth-protocol.md" | sed -e 's/draft-hardt-aauth-bootstrap-date/2026-05-06/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-01/g' -e 's/draft-hardt-aauth-events-date/2026-08-14/g' -e 's/draft-hardt-aauth-events-latest/draft-hardt-aauth-events-00/g' -e 's/draft-hardt-aauth-r3-date/2026-08-14/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-08-06/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-10/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-oauth-aauth-protocol-10\//; }' >$@
	$(LIBDIR)/make-includes.sh "draft-hardt-oauth-aauth-protocol-10" "draft-hardt-oauth-aauth-protocol-10" "$@"
.INTERMEDIATE: versioned/draft-hardt-oauth-aauth-protocol-11.md
versioned/draft-hardt-oauth-aauth-protocol-11.md: draft-hardt-oauth-aauth-protocol.md | versioned
	sed -e 's/draft-hardt-aauth-bootstrap-date/2026-08-14/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-02/g' -e 's/draft-hardt-aauth-budgets-date/2026-08-14/g' -e 's/draft-hardt-aauth-budgets-latest/draft-hardt-aauth-budgets-00/g' -e 's/draft-hardt-aauth-events-date/2026-08-14/g' -e 's/draft-hardt-aauth-events-latest/draft-hardt-aauth-events-00/g' -e 's/draft-hardt-aauth-r3-date/2026-08-14/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-08-14/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-11/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-oauth-aauth-protocol-11\//; }' $< >$@
	$(LIBDIR)/make-includes.sh "HEAD" "draft-hardt-oauth-aauth-protocol-11" "$@"
diff-draft-hardt-oauth-aauth-protocol.html: versioned/draft-hardt-oauth-aauth-protocol-10.txt versioned/draft-hardt-oauth-aauth-protocol-11.txt
	-$(iddiff) $^ > $@
