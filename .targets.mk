# draft-hardt-aauth-bootstrap draft-hardt-aauth-r3 draft-hardt-oauth-aauth-protocol 
...
versioned/draft-hardt-aauth-bootstrap-00.md: | versioned
	git show "draft-hardt-aauth-bootstrap-00:draft-hardt-aauth-bootstrap.md" | sed -e 's/draft-hardt-aauth-bootstrap-date/2026-04-29/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-00/g' -e 's/draft-hardt-aauth-protocol-date/2026-04-13/g' -e 's/draft-hardt-aauth-protocol-latest/draft-hardt-aauth-protocol-01/g' -e 's/draft-hardt-aauth-r3-date/2026-06-17/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-aauth-bootstrap-00\//; }' >$@
...
versioned/draft-hardt-aauth-bootstrap-01.md: | versioned
	git show "draft-hardt-aauth-bootstrap-01:draft-hardt-aauth-bootstrap.md" | sed -e 's/draft-hardt-aauth-bootstrap-date/2026-05-06/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-01/g' -e 's/draft-hardt-aauth-r3-date/2026-06-17/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-05-06/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-01/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-aauth-bootstrap-01\//; }' >$@
...
versioned/draft-hardt-aauth-bootstrap-02.md: draft-hardt-aauth-bootstrap.md | versioned
	sed -e 's/draft-hardt-aauth-bootstrap-date/2026-06-17/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-02/g' -e 's/draft-hardt-aauth-r3-date/2026-06-17/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-06-17/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-07/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-aauth-bootstrap-02\//; }' $< >$@
...
versioned/draft-hardt-aauth-r3-00.md: draft-hardt-aauth-r3.md | versioned
	sed -e 's/draft-hardt-aauth-bootstrap-date/2026-06-17/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-02/g' -e 's/draft-hardt-aauth-r3-date/2026-06-17/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-06-17/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-07/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-aauth-r3-00\//; }' $< >$@
...
versioned/draft-hardt-oauth-aauth-protocol-00.md: | versioned
	git show "draft-hardt-oauth-aauth-protocol-00:draft-hardt-oauth-aauth-protocol.md" | sed -e 's/draft-hardt-aauth-bootstrap-date/2026-04-29/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-00/g' -e 's/draft-hardt-aauth-r3-date/2026-06-17/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-04-29/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-00/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-oauth-aauth-protocol-00\//; }' >$@
...
versioned/draft-hardt-oauth-aauth-protocol-07.md: draft-hardt-oauth-aauth-protocol.md | versioned
	sed -e 's/draft-hardt-aauth-bootstrap-date/2026-06-17/g' -e 's/draft-hardt-aauth-bootstrap-latest/draft-hardt-aauth-bootstrap-02/g' -e 's/draft-hardt-aauth-r3-date/2026-06-17/g' -e 's/draft-hardt-aauth-r3-latest/draft-hardt-aauth-r3-00/g' -e 's/draft-hardt-oauth-aauth-protocol-date/2026-06-17/g' -e 's/draft-hardt-oauth-aauth-protocol-latest/draft-hardt-oauth-aauth-protocol-07/g' -e '/^{::include [^\/]/{ s/^{::include /{::include versioned\/draft-hardt-oauth-aauth-protocol-07\//; }' $< >$@
	$(LIBDIR)/make-includes.sh "HEAD" "draft-hardt-oauth-aauth-protocol-07" "$@"
diff-draft-hardt-oauth-aauth-protocol.html: versioned/draft-hardt-oauth-aauth-protocol-06.txt versioned/draft-hardt-oauth-aauth-protocol-07.txt
	-$(iddiff) $^ > $@
