...
- `interop-demo-profile.md` — Non-normative implementer guidance: minimum live pieces for an end-to-end AAuth interoperability demo, organized as five independently verifiable surfaces.
