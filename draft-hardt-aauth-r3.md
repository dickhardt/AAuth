...
- draft-hardt-aauth-r3-01
  - Dropped the hand-maintained reference block for the AAuth Protocol so the citation resolves from the datatracker, giving the draft revision, date, and datatracker URL rather than a bare repository link.
